...
int MosMain() {
	...
	MIL_INT64 OffsetX = 1280;
	MdigControlFeature(MilDigitizer[0], M_FEATURE_VALUE, MIL_TEXT("OffsetX"), M_TYPE_INT64, &OffsetX);
	MdigControlFeature(MilDigitizer[1], M_FEATURE_VALUE, MIL_TEXT("OffsetX"), M_TYPE_INT64, &OffsetX);
	MdigControlFeature(MilDigitizer[2], M_FEATURE_VALUE, MIL_TEXT("OffsetX"), M_TYPE_INT64, &OffsetX);
	MdigControlFeature(MilDigitizer[3], M_FEATURE_VALUE, MIL_TEXT("OffsetX"), M_TYPE_INT64, &OffsetX);
	MdigControl(MilDigitizer[0], M_SOURCE_OFFSET_X, OffsetX);
	MdigControl(MilDigitizer[1], M_SOURCE_OFFSET_X, OffsetX);
	MdigControl(MilDigitizer[2], M_SOURCE_OFFSET_X, OffsetX);
	MdigControl(MilDigitizer[3], M_SOURCE_OFFSET_X, OffsetX);

	MIL_INT64 OffsetY = 1280;
	MdigControlFeature(MilDigitizer[0], M_FEATURE_VALUE, MIL_TEXT("OffsetY"), M_TYPE_INT64, &OffsetY);
	MdigControlFeature(MilDigitizer[1], M_FEATURE_VALUE, MIL_TEXT("OffsetY"), M_TYPE_INT64, &OffsetY);
	MdigControlFeature(MilDigitizer[2], M_FEATURE_VALUE, MIL_TEXT("OffsetY"), M_TYPE_INT64, &OffsetY);
	MdigControlFeature(MilDigitizer[3], M_FEATURE_VALUE, MIL_TEXT("OffsetY"), M_TYPE_INT64, &OffsetY);
	MdigControl(MilDigitizer[0], M_SOURCE_OFFSET_Y, OffsetY);
	MdigControl(MilDigitizer[1], M_SOURCE_OFFSET_Y, OffsetY);
	MdigControl(MilDigitizer[2], M_SOURCE_OFFSET_Y, OffsetY);
	MdigControl(MilDigitizer[3], M_SOURCE_OFFSET_Y, OffsetY);
	...
	MbufAlloc2d(MilSystem[0], 2560, 2560, 8 + M_UNSIGNED, M_IMAGE + M_DISP + M_GRAB, &MilImage[0]);
	MbufAlloc2d(MilSystem[1], 2560, 2560, 8 + M_UNSIGNED, M_IMAGE + M_DISP + M_GRAB, &MilImage[1]);
	MbufAlloc2d(MilSystem[2], 2560, 2560, 8 + M_UNSIGNED, M_IMAGE + M_DISP + M_GRAB, &MilImage[2]);
	MbufAlloc2d(MilSystem[3], 2560, 2560, 8 + M_UNSIGNED, M_IMAGE + M_DISP + M_GRAB, &MilImage[3]);
	...
	{
		MbufAlloc2d(MilSystem[0], 2560, 2560, 8 + M_UNSIGNED, M_IMAGE + M_GRAB, &MilImageBuf[0][n]);
		MbufAlloc2d(MilSystem[1], 2560, 2560, 8 + M_UNSIGNED, M_IMAGE + M_GRAB, &MilImageBuf[1][n]);
		MbufAlloc2d(MilSystem[2], 2560, 2560, 8 + M_UNSIGNED, M_IMAGE + M_GRAB, &MilImageBuf[2][n]);
		MbufAlloc2d(MilSystem[3], 2560, 2560, 8 + M_UNSIGNED, M_IMAGE + M_GRAB, &MilImageBuf[3][n]);
