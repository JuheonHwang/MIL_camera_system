...
int MosMain() {
	...
	MdigControlFeature(MilDigitizer[0], M_FEATURE_VALUE, MIL_TEXT("TriggerActivation"), M_TYPE_STRING, MIL_TEXT("FallingEdge"));
	...
	MdigControlFeature(MilDigitizer[1], M_FEATURE_VALUE, MIL_TEXT("TriggerActivation"), M_TYPE_STRING, MIL_TEXT("FallingEdge"));
	...
	MdigControlFeature(MilDigitizer[2], M_FEATURE_VALUE, MIL_TEXT("TriggerActivation"), M_TYPE_STRING, MIL_TEXT("FallingEdge"));
	...
	MdigControlFeature(MilDigitizer[3], M_FEATURE_VALUE, MIL_TEXT("TriggerActivation"), M_TYPE_STRING, MIL_TEXT("FallingEdge"));



	MdigControl(MilDigitizer[0], M_IO_MODE + M_AUX_IO4, M_INPUT);
	MdigControl(MilDigitizer[0], M_TIMER_TRIGGER_SOURCE + M_TIMER1, M_AUX_IO4);
	MdigControl(MilDigitizer[0], M_TIMER_DELAY + M_TIMER1, 100);
	MdigControl(MilDigitizer[0], M_TIMER_DURATION + M_TIMER1, 10000);
	MdigControl(MilDigitizer[0], M_TIMER_TRIGGER_ACTIVATION + M_TIMER1, M_EDGE_RISING);
	MdigControl(MilDigitizer[0], M_IO_SOURCE + M_TL_TRIGGER, M_TIMER1);
	MdigControl(MilDigitizer[0], M_TIMER_STATE + M_TIMER1, M_ENABLE);
	...
	MdigControl(MilDigitizer[1], M_TIMER_TRIGGER_SOURCE + M_TIMER1, M_AUX_IO4);
	MdigControl(MilDigitizer[1], M_TIMER_DELAY + M_TIMER1, 100);
	MdigControl(MilDigitizer[1], M_TIMER_DURATION + M_TIMER1, 10000);
	MdigControl(MilDigitizer[1], M_TIMER_TRIGGER_ACTIVATION + M_TIMER1, M_EDGE_RISING);
	MdigControl(MilDigitizer[1], M_IO_SOURCE + M_TL_TRIGGER, M_TIMER1);
	MdigControl(MilDigitizer[1], M_TIMER_STATE + M_TIMER1, M_ENABLE);
	...
	MdigControl(MilDigitizer[2], M_TIMER_TRIGGER_SOURCE + M_TIMER1, M_AUX_IO4);
	MdigControl(MilDigitizer[2], M_TIMER_DELAY + M_TIMER1, 100);
	MdigControl(MilDigitizer[2], M_TIMER_DURATION + M_TIMER1, 10000);
	MdigControl(MilDigitizer[2], M_TIMER_TRIGGER_ACTIVATION + M_TIMER1, M_EDGE_RISING);
	MdigControl(MilDigitizer[2], M_IO_SOURCE + M_TL_TRIGGER, M_TIMER1);
	MdigControl(MilDigitizer[2], M_TIMER_STATE + M_TIMER1, M_ENABLE);
	...
	MdigControl(MilDigitizer[3], M_TIMER_TRIGGER_SOURCE + M_TIMER1, M_AUX_IO4);
	MdigControl(MilDigitizer[3], M_TIMER_DELAY + M_TIMER1, 100);
	MdigControl(MilDigitizer[3], M_TIMER_DURATION + M_TIMER1, 10000);
	MdigControl(MilDigitizer[3], M_TIMER_TRIGGER_ACTIVATION + M_TIMER1, M_EDGE_RISING);
	MdigControl(MilDigitizer[3], M_IO_SOURCE + M_TL_TRIGGER, M_TIMER1);
	MdigControl(MilDigitizer[3], M_TIMER_STATE + M_TIMER1, M_ENABLE);
	...
	MosPrintf(MIL_TEXT("ALL Devices wait for signal...\n"));
