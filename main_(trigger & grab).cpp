...
int MosMain() {
	...
	//MdigControl(MilDigitizer[0], M_TL_TRIGGER_ACTIVATION + M_TL_TRIGGER, M_EDGE_RISING);
	...
	MdigControl(MilDigitizer[0], M_GRAB_TRIGGER_ACTIVATION, M_EDGE_FALLING);
	MdigControl(MilDigitizer[0], M_GRAB_TRIGGER_STATE, M_ENABLE);

	//MdigControl(MilDigitizer[1], M_TL_TRIGGER_ACTIVATION + M_TL_TRIGGER, M_EDGE_RISING);
	...
	MdigControl(MilDigitizer[1], M_GRAB_TRIGGER_ACTIVATION, M_EDGE_FALLING);
	MdigControl(MilDigitizer[1], M_GRAB_TRIGGER_STATE, M_ENABLE);

	//MdigControl(MilDigitizer[2], M_TL_TRIGGER_ACTIVATION + M_TL_TRIGGER, M_EDGE_RISING);
	...
	MdigControl(MilDigitizer[2], M_GRAB_TRIGGER_ACTIVATION, M_EDGE_FALLING);
	MdigControl(MilDigitizer[2], M_GRAB_TRIGGER_STATE, M_ENABLE);

	//MdigControl(MilDigitizer[3], M_TL_TRIGGER_ACTIVATION + M_TL_TRIGGER, M_EDGE_RISING);
	...
	MdigControl(MilDigitizer[3], M_GRAB_TRIGGER_ACTIVATION, M_EDGE_FALLING);
