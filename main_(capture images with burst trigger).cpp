...
int MosMain() {
	...
	MdigControl(MilDigitizer[0], M_GRAB_TRIGGER_SOURCE, M_TL_TRIGGER);
	...
	MdigControl(MilDigitizer[1], M_GRAB_TRIGGER_SOURCE, M_TL_TRIGGER);
	...
	MdigControl(MilDigitizer[2], M_GRAB_TRIGGER_SOURCE, M_TL_TRIGGER);
	...
	MdigControl(MilDigitizer[3], M_GRAB_TRIGGER_SOURCE, M_TL_TRIGGER);
