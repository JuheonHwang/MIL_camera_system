...
int MosMain() {
	...
	MbufFree(MilImage[0]); MbufFree(MilImage[1]);
	MdispFree(MilDisplay[0]); MdispFree(MilDisplay[1]);
	MdigFree(MilDigitizer[0]); MdigFree(MilDigitizer[1]);
	MsysFree(MilSystem[0]); MsysFree(MilSystem[1]);
