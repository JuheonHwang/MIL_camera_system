...
int MosMain() {
	...
	MdigControl(MilDigitizer[0], M_GRAB_MODE, M_SYNCHRONOUS);
	MdigControl(MilDigitizer[1], M_GRAB_MODE, M_SYNCHRONOUS);
	MdigControl(MilDigitizer[2], M_GRAB_MODE, M_SYNCHRONOUS);
	MdigControl(MilDigitizer[3], M_GRAB_MODE, M_SYNCHRONOUS);
