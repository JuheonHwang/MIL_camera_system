...
int MosMain() {
	...
	MIL_ID MilImageBuf[4][1];
	MbufAlloc2d(MilSystem[0], (MIL_INT)(MdigInquire(MilDigitizer[0], M_SIZE_X, M_NULL)), (MIL_INT)(MdigInquire(MilDigitizer[0], M_SIZE_Y, M_NULL)), 8 + M_UNSIGNED, M_IMAGE + M_DISP + M_GRAB, &MilImageBuf[0][0]);
	MbufAlloc2d(MilSystem[1], (MIL_INT)(MdigInquire(MilDigitizer[1], M_SIZE_X, M_NULL)), (MIL_INT)(MdigInquire(MilDigitizer[1], M_SIZE_Y, M_NULL)), 8 + M_UNSIGNED, M_IMAGE + M_DISP + M_GRAB, &MilImageBuf[1][0]);
	MbufAlloc2d(MilSystem[2], (MIL_INT)(MdigInquire(MilDigitizer[2], M_SIZE_X, M_NULL)), (MIL_INT)(MdigInquire(MilDigitizer[2], M_SIZE_Y, M_NULL)), 8 + M_UNSIGNED, M_IMAGE + M_DISP + M_GRAB, &MilImageBuf[2][0]);
	MbufAlloc2d(MilSystem[3], (MIL_INT)(MdigInquire(MilDigitizer[3], M_SIZE_X, M_NULL)), (MIL_INT)(MdigInquire(MilDigitizer[3], M_SIZE_Y, M_NULL)), 8 + M_UNSIGNED, M_IMAGE + M_DISP + M_GRAB, &MilImageBuf[3][0]);

	MbufClear(MilImageBuf[0][0], 0L);
	MbufClear(MilImageBuf[1][0], 0L);
	MbufClear(MilImageBuf[2][0], 0L);
	MbufClear(MilImageBuf[3][0], 0L);
	...
	MdigProcess(MilDigitizer[0], MilImageBuf[0], 1, M_START, M_DEFAULT, ProcessingFunction, &UserHookData[0]);
	MdigProcess(MilDigitizer[1], MilImageBuf[1], 1, M_START, M_DEFAULT, ProcessingFunction, &UserHookData[1]);
	MdigProcess(MilDigitizer[2], MilImageBuf[2], 1, M_START, M_DEFAULT, ProcessingFunction, &UserHookData[2]);
	MdigProcess(MilDigitizer[3], MilImageBuf[3], 1, M_START, M_DEFAULT, ProcessingFunction, &UserHookData[3]);


	MosPrintf(MIL_TEXT("Press Any Key to Stop Process...\n"));
	MosGetch();

	MdigProcess(MilDigitizer[0], MilImageBuf[0], 1, M_STOP, M_DEFAULT, ProcessingFunction, &UserHookData[0]);
	MdigProcess(MilDigitizer[1], MilImageBuf[1], 1, M_STOP, M_DEFAULT, ProcessingFunction, &UserHookData[1]);
	MdigProcess(MilDigitizer[2], MilImageBuf[2], 1, M_STOP, M_DEFAULT, ProcessingFunction, &UserHookData[2]);
	MdigProcess(MilDigitizer[3], MilImageBuf[3], 1, M_STOP, M_DEFAULT, ProcessingFunction, &UserHookData[3]);

	MosPrintf(MIL_TEXT("Process Done!\n"));

	MbufFree(MilImageBuf[0][0]);
	MbufFree(MilImageBuf[1][0]);
	MbufFree(MilImageBuf[2][0]);
	MbufFree(MilImageBuf[3][0]);
